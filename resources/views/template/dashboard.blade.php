...
<html>
    ...
    <body class="grid grid-cols-12 text-center bg-color-bg min-h-screen">
        {{--NAVBAR--}}
        ...
        {{--SIDEBAR--}}
        <div class="col-span-2 bg-gradient-to-bl from-[#00876A] to-[#3a584b] flex flex-col min-h-screen h-auto w-full items-start gap-10 font-secundario pl-5 pt-6 text-aux">
            {{--DASHBOARD--}}
            <div class="">
                <a href="{{ route('home.index') }}" class="flex justify-start items-center gap-3">
                    <img class="h-8" src="{{ asset('images/logo.png') }}" alt="logo-auladelljoyas"></img>
                    <h2 class="text-primary hover:text-aux transition-colors duration-150 font-primario font-medium text-2xl">Auladell Joyas</h2>
                </a>
            </div>
