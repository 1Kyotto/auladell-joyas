	...
	<div class="w-[95%] h-[95%] border border-gray-200 rounded-lg flex flex-col items-center">
		...
		<div class="w-[95%] h-[10%] flex items-center justify-start">
			<div class="border bg-gray-200 rounded-lg">
				<a href="{{ route('product.filter') }}" class="hover:bg-white hover:rounded-xl px-5 py-1">Todo</a>
				<a href="{{ route('product.filter') }}" class="hover:bg-white hover:rounded-xl px-5 py-1">Aros</a>
				<a href="{{ route('product.filter') }}" class="hover:bg-white hover:rounded-xl px-5 py-1">Anillos</a>
				<a href="{{ route('product.filter') }}" class="hover:bg-white hover:rounded-xl px-5 py-1">Brazaletes</a>
				<a href="{{ route('product.filter') }}" class="hover:bg-white hover:rounded-xl px-5 py-1">Collares</a>
			</div>
		</div>
		{{--FILTROS--}}
